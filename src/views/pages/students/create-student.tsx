...
export const schema = z
	.object({
		...
		gender: z.string(strMsg('gênero')).min(1, req('gênero')).default('male'),
...
export function CreateStudentPage() {
	...
	const handleSubmit = hookFormHandleSubmit(async (formData) => {
		...
		try {
			...
			await usersService.createUser({ ...formData, role: 'student' })
	...
	return (
		<Field>
			<Fieldset className="mb-6">
				<Legend className="!text-2xl">Cadastrar aluno</Legend>
				<Text className="!mb-6">
					Insira as informações do aluno para adicionar ao sistema e gerenciar suas aulas.
				</Text>

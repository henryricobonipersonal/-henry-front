...
import { Link } from '@views/components/tw/link'
import { TouchTarget } from '@views/components/tw/button'
		...
		<span className={clsx(className, 'relative')}>
			{current && (
				<motion.span
					...
					className="absolute inset-y-2 -left-4 w-0.5 rounded-full bg-orange-primary dark:bg-white"
				/>
			)}
			{'to' in props ? (
...
export function SidebarLabel({
	...
	return <span {...props} className={clsx(className, 'truncate tracking-tight')} />
}

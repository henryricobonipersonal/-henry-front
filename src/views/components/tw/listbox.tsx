	...
	return (
		<Headless.Listbox {...props} multiple={false}>
			...
			>
				<Headless.ListboxSelectedOption
					...
					className={clsx([
						...
						// Invalid state
						'group-data-[invalid]:border-red-500 group-data-[invalid]:group-data-[hover]:border-red-500 group-data-[invalid]:dark:border-red-500 group-data-[invalid]:data-[hover]:dark:border-red-500',
						// Disabled state
			...
			<Headless.ListboxOptions
				...
				className={clsx(
					// Anchor positioning
					'[--anchor-offset:-1.325rem] [--anchor-padding:theme(spacing.4)] sm:[--anchor-offset:-0.775rem]', // IMPORTANTE MENU HTML PORTAL
					// Base styles

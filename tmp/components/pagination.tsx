			...
			<div className="flex items-center gap-6 lg:gap-8">
				<div className="flex items-center text-sm font-medium">
					...
					<Input
						...
						className="mx-1.5 h-8 w-8 border border-input bg-background p-0 text-center !text-sm !font-medium shadow ring-0 hover:bg-accent hover:text-accent-foreground focus:border-zinc-300 focus:outline-none focus:ring-0 focus-visible:ring-0"
					/>

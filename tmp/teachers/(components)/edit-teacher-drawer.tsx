...
import { EditTeacherForm } from '@/app/(dashboard)/teachers/(components)/edit-teacher-form'
...
export function EditTeacherDrawer({ open, setOpen }: Props) {
	return (
					...
					<div className="flex justify-between items-center border-b-[1px] border-gray200 pt-12 pb-8 px-12 sm:px-5">
						<div>
							...
							<p className="text-gray500 text-sm mt-4">
								Editar dados do professor: Professor 1
							</p>
						</div>
					</div>
